...
export default function DetailPage({ entry, entryId }: DetailPageProps) {
  ...
  return (
    <div className="relative">
      {toggleDelete && (
        <>
          ...
          <section className="fixed inset-0 z-50 flex items-center justify-center p-4">
            <div className="bg-brand-series flex flex-col gap-4 p-8 md:p-12 rounded-xl max-w-md w-full relative">
      ...
      {/* Main content (give it relative z-0 so overlay sits above) */}
      <div className="flex flex-col lg:flex-row max-w-[64rem] relative z-0">
        <div
          className={cn(
